NDefines.NGame.START_DATE = "1939.1.1.12"
...
NDefines.NMilitary.ANTI_AIR_ATTACK_TO_AMOUNT = 0.004
...
NDefines.NNavy.SUBMARINE_REVEAL_POW = 3.4		-- A scaling factor that is applied to the reveal chance in order to make large differences in detection vs visibility more pronounced
...
---Building
NDefines.NBuildings.MAX_SHARED_SLOTS = 56 --amount of potential max building slots in a state
